...
Backend, JSON based web API based on OpenAPI: http://localhost:$BACKEND_PORT/api/

Automatic interactive documentation with Swagger UI (from the OpenAPI backend): http://localhost:$BACKEND_PORT/docs

Adminer, database web administration: http://localhost:$ADMINER_PORT/
